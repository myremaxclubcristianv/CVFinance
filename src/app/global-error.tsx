...
export default function GlobalError({
  ...
  return (
    <html lang="ro">
      <body style={{ backgroundColor: "#050505", color: "#ffffff", fontFamily: "system-ui, -apple-system, sans-serif", margin: 0 }}>
        <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "16px", textAlign: "center" }}>
          <div style={{ maxWidth: "440px", width: "100%", backgroundColor: "#101311", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: "24px", padding: "32px", boxShadow: "0 25px 50px rgba(0, 0, 0, 0.6)" }}>
            ...
            <p style={{ color: "#A1A1AA", fontSize: "0.95rem", marginBottom: "28px", lineHeight: 1.6 }}>
              Aplicația întâmpină o întrerupere temporară. Te rugăm să încerci reîncărcarea sau să te întorci la pagina principală.
            </p>

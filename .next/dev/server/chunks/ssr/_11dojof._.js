...
;
;
function WhatsAppButton({ phone = "40700000000", message = "Bună ziua, doresc o analiză gratuită pentru un credit." }) {
    const handleClick = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$analytics$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["trackEvent"])("whatsapp_click", {
...
const getTrafficMetadata = ()=>{
    ...
    const isTablet = undefined;
    const deviceType = undefined;
};
}),
];

//# sourceMappingURL=_11dojof._.js.map